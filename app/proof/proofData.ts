...
export const CONTRACTS: DeployedContract[] = [
  {
    ...
    purpose: 'Enforces read/write access on-chain — deal-room expiry, dead-drop time-lock, and N-of-M multi-sig approvals.',
  ...
  },
  {
    ...
    purpose: 'Composability gate — pay-to-unlock escrow that another contract reads to release a CDR vault. Trustless data exchange.',
