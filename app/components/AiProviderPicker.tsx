...
const PROVIDERS: ProviderOption[] = [
  ...
  },
  {
    id: 'gemini',
    name: 'Google · Gemini',
    subtitle: 'Gemini 3.x series',
    logo: 'gemini',
    models: ['gemini-3.5-flash', 'gemini-3.1-pro', 'gemini-3.1-flash', 'gemini-3.1-flash-lite'],
  },
];
